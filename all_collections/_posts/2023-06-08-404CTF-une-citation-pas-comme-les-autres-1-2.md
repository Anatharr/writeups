...
![Ghidra decompiled write_quote function]({{site.baseurl}}/assets/images/404ctf/une-citation-pas-comme-les-autres-1-2/write_quote.png)
...
> For example `b'%c%c%c%c%c%c%c%c%c%4651x%n
______________\xff\xff\xff\xff\xff\x7f\x00\x00'` will write `0x1234` at `0x7fffffffffff`
...
![Drake meme]({{site.baseurl}}/assets/images/404ctf/une-citation-pas-comme-les-autres-1-2/meme.png)

</div>
</div>


![vmmap in gdb]({{site.baseurl}}/assets/images/404ctf/une-citation-pas-comme-les-autres-1-2/vmmap.png)
...
> A **sigreturn frame** is a structure used to resume the state of registers as they were before an interruption. This is done by the **sigreturn** syscall, which will pop the sigreturn frame from the stack and replace values of registers according to the frame.
> Read [this article](https://ir0nstone.gitbook.io/notes/types/stack/syscalls/sigreturn-oriented-programming-srop/using-srop) from ir0nstone if you want a quick example of *SigReturn Oriented Programming* (SROP).
> 
...
To generate the frame I used **pwntools**, and then carefully chose all writes operation to do to optimize it. As explained before, the `write_rop` cannot write values less than 10. This is why when I had a value too small to write, let's say `0x09` for the value of **rax**, I wrote `0x0900` instead.

</div>
<div>

![SigReturn Frame generation]({{site.baseurl}}/assets/images/404ctf/une-citation-pas-comme-les-autres-1-2/sigreturn.png)
...
![expl.py output]({{site.baseurl}}/assets/images/404ctf/une-citation-pas-comme-les-autres-1-2/exploit.png)

> ✅ Flag : `404CTF{3H_813N!0U1_C357_M0N_V1C3.`
> `D3P141r3_357_M0N_P14151r.J41M3_QU0N_M3_H41553}`
